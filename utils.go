...
import (
	...
	"github.com/hyperledger/fabric/core/crypto/sm/src"
)
...
func ComputeCryptoHash(data []byte) (gb_hash []byte) {
	fmt.Println("-------->>>>>> into core/util/util.go ComputeCryptoHash function add by jiangwan" )
	fmt.Print("data is")
	println(data)
	...
	fmt.Print("hash is \t")
	fmt.Println(Byte2String(hash,64))
	...
	fmt.Print("gb_hash is \t")
	fmt.Println(Byte2String(gb_hash, 32))
